...
public class Main {
    public static void main(String[] args) {
        ...
        House californiaHouse = new House("Six bed Mansion", "05/07/2028", 10000000,"somehere in east bay", 1, 10000, 17000);
        ...
        if (assetList instanceof House) {
            House house = (House) assetList;
            System.out.println("Address: " + house.getAddress());
        } else if (assetList instanceof Vehicle) {
            Vehicle vehicle = (Vehicle) assetList;
